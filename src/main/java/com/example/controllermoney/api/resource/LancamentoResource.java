...
import com.example.controllermoney.api.dto.Anexo;
...
import com.example.controllermoney.api.event.RecursoCriadoEvent;
import com.example.controllermoney.api.exceptionhandler.ControllerMoneyExceptionHandler;
...
public class LancamentoResource {
	...
	public ResponseEntity<Object> handlePessoaInexistenteOuInativaException(PessoaInexistenteOuInativaException ex) {
		...
		List<ControllerMoneyExceptionHandler.Erro> erros = Arrays.asList(new ControllerMoneyExceptionHandler.Erro(mensagemUsuario, mensagemDesenvolvedor));
